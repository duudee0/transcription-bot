"""
 Телеграм бот взаимодействует с wrapper'ом 
 пока что тестовое исполнение, много костылей нет дизайна
 позволяет пинать любые сервисы через /task
 TODO: иметь готовый набор функций для пользователя 
"""
